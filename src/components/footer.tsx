  ...
  return (
    ...
    <div className='flex justify-between w-full h-auto '>
        ...
        <ul className='space-y-4'>
            ...
            <li>
                <input className=' p-2 mr-2 border-b-2 border-Jet' type='email' placeholder='Enter your email.....'></input>
                <button className='p-2 bg-wenge text-white w-32 rounded outline-none hover:scale-105'>Register</button>
            </li>
