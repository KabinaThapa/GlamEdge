...
export default function Home() {
  ...
  return (
    ...
    <div className='w-[80%] h-auto grid grid-cols-3 place-items-center p-4 space-y-4 border-2 mx-auto'>
      ...
      <Card img={'https://minion-vinovatheme.myshopify.com/cdn/shop/products/1_e6fe8d6a-e054-4a68-ae4c-84dfb4f66d48_1120x.jpg?v=1613984692'}
       width='250'
      title='T-shirt with logo'
      price='$68.00'/>
    
    
      <Card img={'https://minion-vinovatheme.myshopify.com/cdn/shop/products/1_5c0c329d-da3c-4361-a786-e33ac5ea5498_1120x.jpg?v=1614070750'} 
      width='300'
      title='Cardigon with pockets'
      price='$89.00'/>
      
      
      <Card img={'https://minion-vinovatheme.myshopify.com/cdn/shop/products/1_1120x.jpg?v=1613984550'}
       width='250'
    ...
    <section className='w-full h-auto'>
      ...
      <Card img={'https://minion-vinovatheme.myshopify.com/cdn/shop/products/1_4b6df0cc-511d-4f31-8475-08b1346b1921_1120x.jpg?v=1614072211'}
       width='100'
      title='HIGH TURTLENECK JUMPER'
      price='$45.00'/>
      
      
      <Card img={'https://minion-vinovatheme.myshopify.com/cdn/shop/products/4_bf88b3aa-813f-423a-8e55-46fee7f68db9_1120x.jpg?v=1614073956'}
       width='300'
      title='Basic sweat joggers'
      price='$26.00'/>
      
      
      <Card img={'https://minion-vinovatheme.myshopify.com/cdn/shop/products/2_65b663d9-5f7a-4a9c-905a-2679b7edf4db_360x.jpg?v=1614073469'}
       width='250'
      title='Loose fit blazor and trouser set'
      price='$78.00'/>
      
      
      <Card img={'https://minion-vinovatheme.myshopify.com/cdn/shop/products/1_9bf4a17f-966d-4386-a7f4-424ce07c310d_1120x.jpg?v=1613984616'}
      width='250'
      title='Long-Sleeved Shirt'
      price='$32.00'/>
      
      
      <Card img={'https://skudmart.myshopify.com/cdn/shop/products/s-p-8-1_grande.jpg?v=1569978781'} 
      width='300'
      title='Strappy Summer Beach Floral Flared'
      price='$40.00'/>
      
      
      <Card img={'https://websitedemos.net/t-shirts-store-04/wp-content/uploads/sites/1115/2022/07/product-10-a.jpg'}
      width='250'
